namespace UnamiSushi.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<UnamiSushi.DAL.PrimaryContext>
    {
        ...
        protected override void Seed(UnamiSushi.DAL.PrimaryContext context)
        {
            ...
            {
                new Subcategory{SubcategoryName="Classic Sushidos", CategoryID=
                    1, SubcategoryDescription="Based on classic sushi rolls"},//1
            ...
            var menuPictures = new List<MenuPicture>
            {
                ...
                //Sushi Rolls
                new MenuPicture{MenuItemID=20, PicturePathname="~/Photos/Normal/CaliforniaRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/CaliforniaRollThumb.jpg"},
                new MenuPicture{MenuItemID=21, PicturePathname="~/Photos/Normal/PhillyRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/PhillyRollThumb.jpg"},
                new MenuPicture{MenuItemID=22, PicturePathname="~/Photos/Normal/SpicySalmonRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/SpicySalmonRollThumb.jpg"},
                new MenuPicture{MenuItemID=27, PicturePathname="~/Photos/Normal/SquidwardRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/SquidwardRollThumb.jpg"},
                new MenuPicture{MenuItemID=28, PicturePathname="~/Photos/Normal/TridentRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/TridentRollThumb.jpg"},
                new MenuPicture{MenuItemID=29, PicturePathname="~/Photos/Normal/FloridaRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/FloridaRollThumb.jpg"},
                new MenuPicture{MenuItemID=30, PicturePathname="~/Photos/Normal/SuperPandaRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/SuperPandaRollThumb.jpg"},
                new MenuPicture{MenuItemID=32, PicturePathname="~/Photos/Normal/TigerRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/TigerRollThumb.jpg"},
                new MenuPicture{MenuItemID=34, PicturePathname="~/Photos/Normal/AlaskanRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/AlaskanRollThumb.jpg"},
                new MenuPicture{MenuItemID=38, PicturePathname="~/Photos/Normal/CaliforniaWontonRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/CaliforniaWontonRollThumb.jpg"},
                new MenuPicture{MenuItemID=39, PicturePathname="~/Photos/Normal/WolverineRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/WolverineRollThumb.jpg"},
                new MenuPicture{MenuItemID=40, PicturePathname="~/Photos/Normal/VegasRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/VegasRollThumb.jpg"},
                new MenuPicture{MenuItemID=41, PicturePathname="~/Photos/Normal/EskimoRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/EskimoRollThumb.jpg"},
                new MenuPicture{MenuItemID=42, PicturePathname="~/Photos/Normal/CaliforniaCrunchRoll.jpg",
                                ThumbnailPathname="~/Photos/Normal/CaliforniaCrunchRollThumb.jpg"},

                //Asian Grills
                new MenuPicture{MenuItemID=46, PicturePathname="~/Photos/Normal/TofuStirfry.jpg",
                                ThumbnailPathname="~/Photos/Normal/TofuStirfryThumb.jpg"},
                new MenuPicture{MenuItemID=49, PicturePathname="~/Photos/Normal/ShrimpStirfry.jpg",
